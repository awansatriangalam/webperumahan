            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 my-3 my-lg-0">
                        <a class="btn btn-light btn-social mx-2" href="#!"><i class="fas fa-twitter"></i></a>
                        <a class="btn btn-light btn-social mx-2" href="#!"><i class="fas fa-facebook-f"></i></a>
                        <a class="btn btn-light btn-social mx-2" href="#!"><i class="fas fa-instagram"></i></a>
                    </div>
