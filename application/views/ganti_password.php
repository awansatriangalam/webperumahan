            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo base_url('auth/ganti_password_aksi') ?>">
                  ...
                  <div class="form-group">
                    <div class="d-block">
                    	<label for="ulang_pass" class="control-label">Ulangi Kata Sandi</label>                     
                        <input id="ulang_pass" type="password" class="form-control" name="ulang_pass" tabindex="2" autofocus> 
